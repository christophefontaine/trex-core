#ifndef TREX_DRIVERS_LIO_H
#define TREX_DRIVERS_LIO_H
...
class CTRexExtendedDriverBaseLio : public CTRexExtendedDriverBase {
public:
    CTRexExtendedDriverBaseLio();
    ...
    static CTRexExtendedDriverBase * create(){
        return ( new CTRexExtendedDriverBaseLio() );
    }
